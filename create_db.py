...
# Create and connect to new sqlite db
conn = sqlite3.connect('food_inspections.db')
c = conn.cursor()

# Create inspections_raw and inspections_clean tables
...
for row in subset :
  ...
  for i, field in enumerate(fields):
    ...
    # Print businesses with multiple facility_types, and pick the type that appears most frequently using the mode function defined above
