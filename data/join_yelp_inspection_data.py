...
# Fetch yelp data
yelp_restaurant_responses = open('yelp_restaurants_0-900.json')
...
for row in yelp_restaurant_responses:
    ...
    try:
        ...
        result = dict(inspection_values_yelp, **inspection_values_map)
        result.update(yelp_values)   
...
for result in result_list:
    ...
    sql = '''INSERT INTO restaurants_yelp_inspection_nomatch VALUES
